...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_real', type=str, default=r'D:\A_image_inpainting\code\misf-main\result\gt')
    ...
    parser.add_argument('--path_fake', type=str, default=r'D:\A_image_inpainting\code\fwq\misf-xg-zh\result\dh_test-232')
